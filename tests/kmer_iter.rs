...
fn sequence_conversion() {
    ...
    let sequence_kmers: Vec<usize> = vec![0b_01_10_00_11_11_00_00_00_10_00_11_00_10_00,
    ...
    for (iter_kmer, true_kmer) in KmerIter::from(sequence.as_bytes(), 14, false).zip(sequence_kmers.into_iter()) {
